...
df=pd.read_csv('/Users/jhasija9/Desktop/Uber Data Analytics/uber_data.csv')
...
datetime_dim['pick_week_day']=datetime_dim['tpep_pickup_datetime'].dt.weekday
...
datetime_dim['drop_week_day']=datetime_dim['tpep_dropoff_datetime'].dt.weekday
datetime_dim
...
datetime_dim = datetime_dim[['datetime_id', 'tpep_pickup_datetime', 'pick_hour', 'pick_day', 'pick_month', 'pick_year', 'pick_week_day',
                             'tpep_dropoff_datetime', 'drop_hour', 'drop_day', 'drop_month', 'drop_year', 'drop_week_day']]
...
# trip_distance_dim=df[['trip_distance']].reset_index(drop=True)
# trip_distance_dim['trip_distance_id']=trip_distance_dim.index
# passenger_count_dim = passenger_count_dim[['trip_distance_id', 'trip_distance']]
